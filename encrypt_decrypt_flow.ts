/**
Simple demo that show how to generate crypt keys pair for encrypt / decrypt purpose.
Among key generation, and their usage the import of public key is also showed.
(The owner of the private key the only one who can read the cipher. So probably you may want to export public key to someone, who will create cipher.)
**/
